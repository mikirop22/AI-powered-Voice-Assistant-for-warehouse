...
def visualitza(magatzem, camino, pick_locations):
    ...
    imagen_estanteria = pygame.image.load("estanteria.jpg")
...
def visualitza(magatzem, camino, pick_locations):
    ...
    pygame.quit()
>>>>>>> a0c9f09ee1e797657d2061e253248a0321fe62ba:pygame/visualitzar.py
